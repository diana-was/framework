...
class Cron_EventCrunch extends Model
{
    private $kissmetrics;
    /*
...
echo "using log: $log";
Model::setLog($log);
Model::printTime("Status: starting up eventsCrunch.php ".date('Y-m-d H:i:s',  strtotime('now')));
...
Model::printTime("Status: finish eventsCrunch.php ".date('Y-m-d H:i:s',  strtotime('now')));
exit(0);
?>
